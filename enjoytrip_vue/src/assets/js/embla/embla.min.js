!(function (n, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(e)
    : ((n = "undefined" != typeof globalThis ? globalThis : n || self).EmblaCarousel = e());
})(this, function () {
  "use strict";
  function n() {
    return (n =
      ...
      constrain: function (i) {
        if (!o && n.reachedAny(t.get()) && n.reachedAny(e.get())) {
          var a = i ? 0.7 : 0.45,
            u = t.get() - e.get();
          t.subtract(u * a),
            !i && Math.abs(u) < 10 && (t.set(n.constrain(t.get())), r.useSpeed(10).useMass(3));
        }
      },
  ...
  function v(n, t, r, o, i) {
    var a = e(r.min + t.measure(0.1), r.max + t.measure(0.1)),
      u = a.reachedMin,
      c = a.reachedMax;
    return {
      loop: function (e) {
  ...
  function M(n, r, i, a, u) {
    var f,
      ...
      Y = (function (n, t, r) {
        var o, i;
        return { limit: ((o = t[0]), (i = s(t)), e(r ? o - n : i, o)) };
      })(W, J, T).limit,
      K = t(d(J), E, T),
      Q = K.clone(),
      Z = c(i),
      $ = (function (n) {
        ...
        n && !un.dragHandler.pointerDown() && (un.animation.stop(), u.emit("settle")),
          n || u.emit("scroll"),
          T && (un.scrollLooper.loop(un.scrollBody.direction()), un.slideLooper.loop()),
          un.translate.to(nn),
        ...
        return {
          byDistance: function (t, r) {
            var c = o.get() + t,
              ...
              l = d.distance,
              p = !n && i(c);
            return !r || p ? { index: f, distance: t } : { index: f, distance: t + s(e[f] - l, 0) };
          },
      ...
      an = (function (n, e, t, r, o, i) {
        ...
        function c(e, o) {
          ...
          return r.map(function (r, o) {
            return { start: r - t[o] + i[o] + e, end: r + n - i[o] + e, index: o };
          });
        }
        return {
          check: function (n) {
  ...
  return function (e, t) {
    ...
    function E(t) {
      if (
        ...
        if (!a.slideLooper.canLoop()) return C(), E({ loop: !1 });
        a.slideLooper.loop();
      }
      b.draggable &&
        c.offsetParent &&
        ...
        b.selectedClass && (T(), d.on("select", T).on("pointerUp", T)),
        x ||
          (setTimeout(function () {
            return d.emit("init");
          }, 0),
