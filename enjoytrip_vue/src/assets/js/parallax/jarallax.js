 ...
 */
const bgImageUrl = "/src/assets/images/main.jpg";
...
!(function (e) {
  ...
  function (e, t, n) {
      ...
      return (
        ...
        (function (e, t) {
          ...
          try {
            for (
              n = n.call(e);
              !(r = (o = n.next()).done) && (a.push(o.value), !t || a.length !== t);
              r = !0
            );
          } catch (e) {
            (l = !0), (i = e);
    ...
    var v = 0,
        ...
        return (
          ...
          (n = [
                        ...
                        (n = e.extend(
                          {
                            ...
                            // "background-image":
                            //   e.image.bgImage || 'url("'.concat(e.image.src, '")'),
                            "background-image": 'url("'.concat(bgImageUrl, '")'),
                          },
                          t,
                          n
                        ))),
            ...
            },
            {
              ...
              value: function () {
                b.push({ instance: this }), 1 === b.length && a.window.requestAnimationFrame(h);
              },
            },
            {
              ...
              value: function (e) {
                ...
                if (
                  ...
                  (t.isElementInViewport =
                    0 <= l.bottom && 0 <= l.right && l.top <= p && l.left <= a.window.innerWidth),
                  ...
                  var s = Math.max(0, o),
                    ...
                    y = 1;
                  if (
                    (i < p ? (y = 1 - (u || d) / i) : c <= p ? (y = c / p) : m <= p && (y = m / p),
      ...
      w = function (e, t) {
        ("object" === ("undefined" == typeof HTMLElement ? "undefined" : s(HTMLElement))
        ...
        for (
          var n, o = e.length, i = 0, a = arguments.length, r = new Array(a > 2 ? a - 2 : 0), l = 2;
          l < a;
          l++
        )
          r[l - 2] = arguments[l];
