...
!(function (e, t) {
  ...
  function T(e) {
    var t = !!e && "length" in e && e.length,
      n = x(e);
    return (
      !h(e) && !g(e) && ("array" === n || 0 === t || ("number" == typeof t && 0 < t && t - 1 in e))
    );
  }
  (w.fn = w.prototype =
    {
    ...
    w.extend({
      ...
      makeArray: function (e, t) {
        var n = t || [];
        return (
          null != e && (T(Object(e)) ? w.merge(n, "string" == typeof e ? [e] : e) : a.call(n, e)), n
        );
      },
                        ...
                        (l = e && ("object" == typeof e || "function" == typeof e) && e.then),
                          h(l)
                            ? i
                              ...
                              : (o++,
                                l.call(e, a(o, n, R, i), a(o, n, M, i), a(o, n, R, n.notifyWith)))
                      ...
                      : function () {
                          try {
                            ...
                            w.Deferred.exceptionHook && w.Deferred.exceptionHook(e, c.stackTrace),
                              o <= t + 1 &&
                                (r !== M && ((s = void 0), (u = [e])), n.rejectWith(s, u));
                          }
                        };
                  t
                    ? c()
  ...
  function Pe(e, t, n, r) {
    ...
    if (
      ...
      for (u = (s = w.map(ve(i, "script"), Le)).length; f < p; f++)
        (l = i),
          f !== g && ((l = w.clone(l, !0, !0)), u && w.merge(s, ve(l, "script"))),
          n.call(e[f], l, f);
      if (u)
      ...
      attr: function (e, t, n) {
        ...
        if (3 !== o && 8 !== o && 2 !== o)
          return void 0 === e.getAttribute
            ? w.prop(e, t, n)
            : ((1 === o && w.isXMLDoc(e)) ||
                (i = w.attrHooks[t.toLowerCase()] || (w.expr.match.bool.test(t) ? pt : void 0)),
              void 0 !== n
                ? null === n
    ...
    trigger: function (t, n, r, i) {
      ...
      if (
        ...
        3 !== r.nodeType &&
          ...
          (l = m.indexOf(":") < 0 && "on" + m),
          ((t = t[w.expando] ? t : new w.Event(m, "object" == typeof t && t)).isTrigger = i
            ? 2
            : 3),
          (t.namespace = x.join(".")),
  ...
  function Dt(e, t, n, r) {
    ...
    if (Array.isArray(t))
      w.each(t, function (t, i) {
        n || St.test(e)
          ? r(e, i)
          : Dt(e + "[" + ("object" == typeof i && null != i ? t : "") + "]", i, n, r);
      });
      ...
      ajax: function (t, n) {
        ...
        var r,
          ...
          E = {
            ...
            setRequestHeader: function (e, t) {
              return (
                null == l && ((e = T[e.toLowerCase()] = T[e.toLowerCase()] || e), (b[e] = t)), this
              );
            },
        ...
        d.hasContent
          ...
          : ((p = d.url.slice(i.length)),
            ...
            !1 === d.cache &&
              ((i = i.replace(Lt, "$1")), (p = (Et.test(i) ? "&" : "?") + "_=" + Ct.guid++ + p)),
            (d.url = i + p)),
        d.ifModified &&
      ...
      if (s || "jsonp" === t.dataTypes[0])
        return (
          ...
          s
            ...
            : !1 !== t.jsonp && (t.url += (Et.test(t.url) ? "&" : "?") + t.jsonp + "=" + i),
