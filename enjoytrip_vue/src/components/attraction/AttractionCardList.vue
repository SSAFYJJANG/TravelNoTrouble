...
const { clickLikeBnt,searchAttractionList } = storeToRefs(attractionStore);
...
<template>
    <div>
        ...
        <AttractionCardItem v-for="attraction in likefilterAttraction" :key="attraction.content_id"
            :attraction="attraction" @push-heart="onPushHeart"/>
        <!-- <AttractionCardItem/> -->
    </div>
</template>
