!(function () {
    ...
    if (!u && document.body) {
      ...
      if (
        ...
        (m.style.cssText =
          ...
          A("resize", o);
        if (
          ((t = new q(o)).observe(n, { attributes: !0, childList: !0, characterData: !1 }),
          s.offsetHeight <= c)
        ) {
      ...
      a.fixedBackground ||
        l ||
        ((n.style.backgroundAttachment = "scroll"), (r.style.backgroundAttachment = "scroll"));
    }
  }
  var p = [],
    v = !1,
  ...
  function g(t) {
    ...
    return c
      ...
      : !i ||
          !U ||
          (Object.defineProperty(t, "target", { value: window.frameElement }), parent.wheel(t));
  }
  function S(t) {
    var o = t.target,
