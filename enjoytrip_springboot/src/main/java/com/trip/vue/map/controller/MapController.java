...
public class MapController {
	...
	public ResponseEntity<?> insertAttraction(@PathVariable("userid") String userid, @RequestBody int content_id) throws Exception{
		try {
			Map<String, Object> map = new HashMap<>();
			map.put("content_id", content_id); map.put("userid", userid);
