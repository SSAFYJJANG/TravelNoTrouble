                ...
                (function(){
                    !function(e){
                        "resize"===e.type&&(
                            ...
                            Array.from(document.querySelector(".navbar-dropdown").querySelectorAll('.navbar-toggler[aria-expanded="true"]')).
                            forEach((e=>{let t=e.querySelector(e.getAttribute("data-target")
                        );
                        t&&(
