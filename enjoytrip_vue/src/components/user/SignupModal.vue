<script setup>
// userid password username email sido gugun
</script>

<template>
  <section data-bs-version="5.1" class="form03 cid-uc424dM66e" id="form03-19">
    <div class="container">
      <div class="row justify-content-center">
          ...
          <div class="col-lg-12 mx-auto mbr-form" data-form-type="formoid">
            ...
            >
              <div class="dragArea row">
                <div
                  class="col-md col-sm-12 form-group mb-3 mb-3"
                  data-for="password"
                >
                  <input
                    type="password"
                ...
                <div class="col-12 form-group mb-3 mb-3" data-for="username">
                  <input
                    type="text"
                    name="username"
                    placeholder="Name"
        ...
        <div class="signup-img col-12 col-lg-6">
